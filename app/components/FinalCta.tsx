    ...
    <section className="relative z-10 bg-black sm:bg-transparent px-4 sm:px-6 pt-[10px] pb-[6px] sm:pt-[80px] sm:pb-[80px] text-white overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[800px] text-center">
        ...
        <ScaleIn delay={0.1} startScale={0.88}>
          <h2 className="mb-8 sm:mb-10 text-[32px] leading-[0.95] font-medium sm:leading-[1.05] tracking-[-6%] sm:text-[48px]">
            we are your{" "}
            <span className="font-[var(--font-cormorant)] text-[42px] sm:text-[64px] font-light timesFontFamily italic">
              360&deg;
            </span>
            <br />
            <span className="font-[var(--font-cormorant)] text-[42px] sm:text-[64px] font-normal timesFontFamily italic">
              marketing agency
            </span>
          </h2>
        </ScaleIn>
