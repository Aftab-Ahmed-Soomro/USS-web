    ...
    <div className="min-h-screen -mt-8 sm:mt-0 bg-[#080808] text-white">
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-black sm:py-16 py-12 md:py-24 lg:py-32 text-black">
          ...
          <div className="mx-auto max-w-[1200px]  px-6 min-[375px]:px-6 grid grid-cols-1 md:grid-cols-[240px_1fr] lg:grid-cols-[280px_1fr] gap-10 sm:gap-30 lg:gap-40 items-start">
