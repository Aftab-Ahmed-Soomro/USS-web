...
export default function PlatformsWeWorkWith({
  ...
  return (
    <section className="bg-[#000] py-[0px] sm:pt-16 sm:pb-6 px-4 sm:px-6 relative">
      <Stagger staggerDelay={0.15}>
        <StaggerItem>
          {heading ? (
            ...
            <h2
              className="text-white mx-auto max-w-[1200px] xl:max-w-[1300px]  mb-[32px] sm:mb-10 font-medium text-[29px] sm:text-[40px] leading-none tracking-normal text-center sm:text-left"
            >
        ...
        <div className="relative max-w-[1200px] xl:max-w-[1300px]  mx-auto">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 px-[16px] sm:px-5 py-[16px] sm:py-6">
                        <div className="mt-auto flex flex-col justify-end">
                          ...
                          {platform.description && (
                            <div
                              className={`grid transition-all duration-500 ease-in-out sm:group-hover:grid-rows-[1fr] sm:group-hover:opacity-100 ${isActive ? 'grid-rows-[1fr] opacity-100 mt-1.5 sm:mt-2' : 'grid-rows-[0fr] opacity-0 mt-0 sm:group-hover:mt-1.5 sm:group-hover:sm:mt-2'
                                }`}
                            >
