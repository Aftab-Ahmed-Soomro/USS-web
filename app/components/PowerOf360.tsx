...
export function PowerOf360() {
  ...
  return (
    ...
    >
      ...
      {/* Content — balanced flex layout inside max-w-[1200px] xl:max-w-[1300px] container */}
      <div className="relative z-10 mx-auto max-w-[1200px] xl:max-w-[1300px] w-full flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-10 px-4 min-[375px]:px-6 py-10 sm:py-14 md:py-20 lg:py-24">
        {/* ── LEFT: text block ── */}
