...
export function ContentCreationGrid() {
  return (
    <div className="w-full mx-auto max-w-[1150px] 2xl:max-w-[1440px] px-4 min-[375px]:px-6 mt-[32px] sm:mt-[48px] flex flex-col gap-[16px] sm:gap-[20px] lg:gap-[29px]">
      {/* Block 1 */}
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-[20px] lg:gap-[29px]">
        ...
        <div className="col-span-2 flex flex-col gap-2 sm:gap-[20px] lg:gap-[29px]">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-[20px] lg:gap-[29px]">
            <FadeUp delay={0.2}>
              <div className="relative w-full aspect-[355/400] rounded-[8px] sm:rounded-[16px] overflow-hidden bg-[#111]">
                <Image src="/assets/cocoa.png" alt="Gallery image 8" fill className="object-cover object-[center_42%] sm:object-center hover:scale-105 transition-transform duration-700" sizes="(max-width: 768px) 100vw, 33vw" />
              </div>
            </FadeUp>
            <FadeUp delay={0.3}>
              <div className="relative w-full aspect-[355/400] rounded-[8px] sm:rounded-[16px] overflow-hidden bg-[#111]">
        ...
        <div className="flex flex-col gap-2 sm:gap-[20px] lg:gap-[29px]">
          <FadeUp delay={0.15}>
            <div className="relative w-full aspect-[355/253] rounded-[8px] sm:rounded-[16px] overflow-hidden bg-[#111]">
              <Image src="/assets/level.jpg" alt="Gallery image 7" fill className="object-cover object-center hover:scale-105 transition-transform duration-700" sizes="(max-width: 768px) 100vw, 33vw" />
            </div>
          </FadeUp>
          <FadeUp delay={0.35}>
            <div className="relative w-full aspect-[355/543] rounded-[8px] sm:rounded-[16px] overflow-hidden bg-[#111]">
              <Image src="/assets/contentImages/10.png" alt="Gallery image 10" fill className="object-cover object-[center_25%] sm:object-center hover:scale-105 transition-transform duration-700" sizes="(max-width: 768px) 100vw, 33vw" />
            </div>
          </FadeUp>
        </div>
      </div>
