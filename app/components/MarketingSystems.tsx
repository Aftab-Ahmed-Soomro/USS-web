...
const rawSystems = [
  ...
  { title: "WEBSITE\nTRANSFORMATION", icon: "/assets/marketingGrowths/websiteTransformationIcon.png", href: "/website-development" },
];
  ...
  return (
    <section className="bg-black py-10 sm:py-14 px-4  flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="text-center mt-16 z-10 flex flex-col items-center max-w-[800px] px-6">
        ...
        <FadeUp delay={0.3}>
          <p className="text-white text-[15px] sm:text-[17px] font-normal leading-[26px] tracking-[1%]">
