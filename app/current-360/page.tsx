...
function Hero() {
    return (
        <main className="relative z-10 mx-auto grid max-w-[1200px] xl:max-w-[1300px]  flex-1 items-center gap-12 px-6 pb-[68px] pt-[58px]  md:grid-cols-[minmax(0,1fr)_431px] md:gap-14  lg:pb-[74px] lg:pt-[79px] xl:grid-cols-[575px_431px] xl:gap-[132px] bg-white">
