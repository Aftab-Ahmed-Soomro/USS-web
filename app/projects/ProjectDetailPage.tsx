  ...
  return (
    <main className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="bg-[#f7f7f5] px-4 min-[375px]:px-6 pb-[38px] pt-[42px] sm:pb-[44px] sm:pt-[55px] lg:pt-[64px]">
        <div className="mx-auto grid max-w-[1150px] 2xl:max-w-[1440px] items-start justify-between gap-10 sm:gap-14 lg:grid-cols-[550px_566px] lg:gap-[64px]">
      ...
      <section className="bg-[#f7f7f5] px-6 pb-[40px] pt-[40px] sm:pb-[82px] sm:pt-[82px]">
        <div className="mx-auto grid max-w-[1150px] 2xl:max-w-[1440px] gap-12 sm:gap-14 lg:grid-cols-[840px_300px] lg:gap-[30px]">
          <div>
