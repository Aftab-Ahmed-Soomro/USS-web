...
export default function IndustriesServed() {
  ...
  return (
    <section className="bg-[#0b0b0b] text-white py-20 w-full overflow-hidden">
      
      {/* Text Header Section */}
      <div className="w-full mx-auto px-6 md:px-12 lg:px-[100px]" style={{ maxWidth: '1442px' }}>
        <div className="mb-14 flex flex-col items-start text-left">
          <h2 
            ...
            style={{
              ...
              fontSize: '56px',
              lineHeight: '75.6px',
              letterSpacing: '-3.16px',
              verticalAlign: 'middle',
            }}
          >
            Industries we have <span className="timesFontFamily font-serif text-[72px] font-normal italic">served</span>
          </h2>
          <p 
      ...
      >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none px-4">
            <div 
              className="bg-[#f0f0f0] text-black px-8 py-3.5 rounded-sm shadow-xl" 
              style={{
                fontWeight: 400,
                fontSize: '16px',
                lineHeight: '21.12px',
          ...
          <div className="absolute bottom-0 left-0 w-full px-8 md:px-12 py-10 flex flex-col md:flex-row justify-between items-start md:items-end bg-gradient-to-t from-black/90 via-black/40 to-transparent">
            
            {/* Bottom Left Text */}
            <p 
              className="text-white mb-6 md:mb-0 md:pr-10" 
              style={{
                fontWeight: 600,
                fontSize: '14px',
                lineHeight: '22.75px',
