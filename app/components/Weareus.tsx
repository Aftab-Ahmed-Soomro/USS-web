...
export default function WeAreUSS() {
  return (
    <section className="relative w-full bg-[#080808] overflow-hidden py-0 sm:py-16 px-4 min-[375px]:px-6 lg:px-0 max-w-[1150px] mx-auto">
      <div className="relative grid grid-cols-1 lg:grid-cols-[1fr_auto_1.5fr] items-center">
        ...
        <FadeLeft delay={0.1} className="relative z-10">
          <div className="relative z-1000 flex items-center justify-center min-[480px]:justify-start lg:justify-end py-8 sm:py-16 lg:py-0 lg:-mr-26 order-1 lg:order-none pointer-events-none">
            <h2
              className="text-white font-bold uppercase leading-[1.1] lg:leading-[116.28px] mt-4 lg:mt-20 tracking-[-1px] lg:tracking-[-2.74px] whitespace-nowrap text-[50px] min-[375px]:text-[64px] sm:text-[80px] lg:text-[clamp(6rem,7vw,7rem)]"
        ...
        <FadeRight delay={0.1} className="relative z-10">
          <div className="relative z-1000 flex items-center justify-center min-[480px]:justify-start lg:justify-end py-8 sm:py-16 lg:py-0 ml-0 lg:-ml-2 order-3 lg:order-none">
            <div className="text-center min-[480px]:text-left lg:text-right text-[#FFFFFF] max-w-[440px] flex flex-col gap-6 sm:gap-8">
