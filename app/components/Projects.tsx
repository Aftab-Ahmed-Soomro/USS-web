...
export function Projects() {
  return (
    ...
    >
      <div className="flex w-full max-w-[1200px] xl:max-w-[1300px]  flex-col items-center gap-8">
      ...
      <div className="grid w-full max-w-[1200px] xl:max-w-[1300px]  grid-cols-1 justify-items-center gap-6 md:grid-cols-3">
