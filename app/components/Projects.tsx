...
export function Projects() {
  return (
    ...
    >
      <div className="flex w-full max-w-[1150px] 2xl:max-w-[1440px] flex-col items-center gap-8">
      ...
      <div className="grid w-full max-w-[1150px] 2xl:max-w-[1440px] grid-cols-1 justify-items-center gap-6 md:grid-cols-3">
