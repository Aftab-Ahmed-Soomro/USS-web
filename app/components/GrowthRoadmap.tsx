...
export function GrowthRoadmap() {
  return (
    <section className="relative w-full bg-black py-[60px] sm:py-20 px-4 min-[375px]:px-6 overflow-hidden">
        ...
        <Stagger staggerDelay={0.15}>
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 lg:items-center mb-16 sm:mb-24">
            <div className="shrink-0">
              ...
              <StaggerItem>
                <h2 className="text-white m-0 p-0 flex flex-col">
                  <span
                    style={{
                      fontWeight: 500,
            ...
            <div className="flex lg:justify-end lg:items-center h-full">
              <StaggerItem>
                <p 
                  className="text-neutral-400 max-w-[700px] text-left lg:text-right"
                  style={{
                    fontWeight: 400,
                    fontSize: '18px',
                    lineHeight: '30.6px',
