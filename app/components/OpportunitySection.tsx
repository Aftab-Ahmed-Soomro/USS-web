...
export function OpportunitySection() {
  return (
    <section className="bg-black py-20 text-white flex flex-col items-center overflow-hidden">
      {/* Header Section */}
      <FadeUp>
        <div className="text-center px-6 mb-10 sm:mb-16 max-w-[1200px] xl:max-w-[1300px]  mx-auto">
          <h2
          ...
          >
            We work with high performing YouTubers to monetise their platforms effectively and maximise their revenue using strategic marketing system
          </p>
        </div>
      </FadeUp>

      {/* Image Grid Section */}
      <Stagger className="w-full max-w-[1200px] xl:max-w-[1300px] px-5.5 mx-auto flex flex-col md:flex-row justify-center items-start gap-10 md:gap-8">
