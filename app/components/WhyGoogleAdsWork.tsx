      ...
      <div className="mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center relative w-full">
          ...
          <div className="flex-1 w-full flex flex-col justify-center items-center px-6 py-[40px] sm:py-[40px]">
            {/* Heading */}
            <div className="w-full sm:-mt-15 flex justify-center">
              <FadeRight delay={0.1}>
                <h2
