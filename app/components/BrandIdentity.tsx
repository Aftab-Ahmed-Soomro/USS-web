        ...
        <Stagger staggerDelay={0.15} className="flex flex-col items-center w-full">
          ...
          <StaggerItem>
            <div className="flex flex-col items-center gap-4 mb-8">
              <h2 className="text-white font-medium text-[40px] sm:text-[56px] leading-[1.1] sm:leading-[60px] tracking-[-2px] sm:tracking-[-3.2px] text-center lowercase">
                brand identity
              </h2>
              <p className="text-white/90 font-normal text-[16px] sm:text-[18px] leading-[1.6] sm:leading-[32px] text-center max-w-[600px]">
