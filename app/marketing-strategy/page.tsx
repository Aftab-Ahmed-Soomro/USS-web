...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-black px-4 min-[375px]:px-6 pb-[40px] pt-[40px] text-white sm:pb-[72px] sm:pt-[78px]">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1150px] px-6 gap-8 sm:gap-10 lg:grid-cols-[minmax(0,420px)_minmax(0,640px)] lg:items-center lg:justify-between">
