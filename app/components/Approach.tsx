...
const approachSteps = [
  {
    ...
    image: "/assets/approach/content_strategy.webp",
  ...
  },
  {
    ...
    image: "/assets/approach/content_creation.webp",
  ...
  },
  {
    ...
    image: "/assets/approach/audience.webp",
  ...
  },
  {
    ...
    image: "/assets/approach/growth.webp",
...
export function Approach() {
  return (
    <section className="relative z-10 border-t border-[#060606]/10 bg-white px-6 py-[46px] text-[#060606]  lg:py-[50px]">
      <div className="mx-auto flex max-w-[1200px] xl:max-w-[1300px]  flex-col items-start">
