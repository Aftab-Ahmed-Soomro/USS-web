...
export function BlackFridayOpportunity() {
  ...
  return (
    <section className="bg-white py-16 sm:py-24 text-black overflow-hidden flex flex-col items-center relative">
      ...
      <FadeUp>
        <div className="max-w-[1200px]  text-center px-6 mx-auto mb-10 sm:mb-16">
          ...
          >
            ...
            <span
              className="text-[#FF5500] italic font-medium font-[var(--font-cormorant)] timesFontFamily text-[38px] sm:text-[72px] leading-[0] sm:leading-[0px] tracking-[-1px] sm:tracking-[-3.2px]"
            >
              revenue opportunity
            </span>
          </h2>
      ...
      {/* Features Section */}
      <div className="relative w-full max-w-[1200px]  mx-auto md:px-4">
